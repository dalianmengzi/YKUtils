...
public extension CGFloat{
    ...
    static func getTextHeight(param:String,width:CGFloat,fontSize:CGFloat) -> CGFloat {
        ...
        let textSize = str.boundingRect(with: CGSize.init(width: width, height: CGFloat(MAXFLOAT)), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font:UIFont.HelveticaNeue_Light(size: fontSize),NSAttributedString.Key.foregroundColor:UIColor.white], context: nil)
